    ...
    public partial class FirstCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudSubTeachs", x => x.StudentSubjectID);
                    table.ForeignKey(
                        name: "FK_StudSubTeachs_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudSubTeachs_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "SubjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudSubTeachs_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "TeacherId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSubjects", x => x.TeacherSubjectsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudSubTeachs_StudentId",
                table: "StudSubTeachs",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudSubTeachs_SubjectId",
                table: "StudSubTeachs",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_StudSubTeachs_TeacherId",
                table: "StudSubTeachs",
                column: "TeacherId");
